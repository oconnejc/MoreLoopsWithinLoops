...
def largest_number(seq_seq):
    ...
    # ------------------------------------------------------------------
    largest = -9999999999999999999999999999999999999
    for k in range(len(seq_seq)):
        for i in range(len(seq_seq[k])):
            if seq_seq[k][i] > largest:
                largest = seq_seq[k][i]
    if largest == -9999999999999999999999999999999999999:
        return 'none'
    else:
        return largest
...
def run_test_largest_negative_number():
    ...
    # Test 2:
    expected = -2
    answer = largest_number([(-2,-4,-5,-2,-5),
                             (0,1),
                             [-3,-2,-3,5,-7]])
    print('Expected and actual are:', expected, answer)
...
def largest_negative_number(seq_seq):
    ...
    for k in range(len(seq_seq)):
        for i in range(len(seq_seq[k])):
            if seq_seq[k][i] > largest and seq_seq[k][i] < 0:
                largest = seq_seq[k][i]
    if largest == -9999999999999999999999999999999999999:
        return 'none'
    else:
...
def first_is_elsewhere_too(seq_seq):
    ...
    for k in range(len(seq_seq[0])):
        a = seq_seq[0][k]
        for i in range(len(seq_seq)-1,0,-1):
